...
public class AppActivity_test extends AppCompatActivity{
...
//        }
        ...
        dbHelper.shopItemInsert("100", "사과", 10000);
        dbHelper.shopItemInsert("100", "배", 20000);


        Log.v("tempLog  :  ", "dbHelper.shopItemSelect:  " + dbHelper.shopItemSelect("100", "사과", 10000));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(type.equals("PLACE_ENTER")){
                    Intent  intent = new Intent(AppActivity_test.this, PlaceDetailActivity.class);
...
//                    iv.setImageResource(R.drawable.popup_img1);
    ...
    private void bringAppToForeground() {
        Intent intent = new Intent(this, AppActivity_test.class);
